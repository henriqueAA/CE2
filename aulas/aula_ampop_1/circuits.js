...
\node [font=\Large] at (10.25,8) {$R_{P}=100\Omega$};
\node [font=\Large] at (10.25,4.25) {$R_{P}=100\Omega$};
\node [font=\Large] at (14.25,8) {$R_{P}=100\Omega$};
\node [font=\Large] at (18,5) {$R_{SG}=100.1\Omega$};
\node [font=\Large] at (17.75,4.25) {$(R_{P}+\Delta R)$};
\node [font=\Large] at (25.5,10.5) {$R_{B}=800K\Omega$};
\node [font=\Large] at (25.75,3.75) {$R_{B}=800K\Omega$};
\node [font=\Large] at (22.25,7) {$R_{A}=1K\Omega$};
\node [font=\Large] at (22.25,5.5) {$R_{A}=1K\Omega$};
\draw [ line width=0.8pt](27.5,7.25) to[short, -o] (28,7.25) ;
\node [font=\Large, color={rgb,255:red,0; green,0; blue,255}] at (28,7.75) {$V_{o}$};
\draw [ line width=0.8pt](16,5.75) to[short, -o] (14.75,5.75) ;
\node [font=\Large, color={rgb,255:red,0; green,0; blue,255}] at (13,6.25) {$V_{2}$};
\node [font=\Large, color={rgb,255:red,0; green,0; blue,255}] at (15,6.25) {$V_{1}$};
\draw [ line width=0.8pt](27.7,7.25) to[short](28,7.25);
\draw [ line width=0.8pt](27.7,7.25) to[short](28,7.25);
\draw [ line width=0.8pt](17.5,5.75) to[short] (17.5,7.25);
\draw [ line width=0.8pt](17.5,7.25) to[short] (18,7.25);
...
\draw [ line width=0.8pt](21,1.25) to[short] (21,2.75);
\draw [ line width=0.8pt](21,2.75) to[short] (21,4.75);
\node [font=\Large] at (19.25,9.25) {$Buffer$};
\node [font=\Large] at (19.5,2.75) {$Buffer$};
\draw [ line width=0.8pt](16,5.75) to[short] (17.5,5.75);
\draw [ line width=0.8pt](18,0.75) to[short] (12.75,0.75);
\draw [ line width=0.8pt](20.7,1.25) to[short](21,1.25);
\draw [ line width=0.8pt](20.7,1.25) to[short](21,1.25);
